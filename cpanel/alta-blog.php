            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Alta Tema</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Alta Tema</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alta Tema</h4>
                                <div class="row" style="margin-top: 34px;">
									...
									<div class="form-group">
                                        <label>Extracto</label>
                                         <input type="input" class="form-control" name="excerp" maxlength="310"> 
									</div>
									</div>
                            ...
                            <div class="card-body">
                                <div class="row" style="margin-top: 34px;">
						            ...
						            <input type="hidden" name="i_principal" value="<?php echo $row_edit['foto'];?>">
										<button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Alta Tema</button>
								</div>
                            </div>
                        </div>	
