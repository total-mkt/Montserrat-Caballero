...
<head>
    ...
    <title>Alta Logro - <?php echo $title?></title>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Alta Logro</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="./"><?php echo _INICIO?></a></li>
                                <li class="breadcrumb-item"><a href="./catalogo-logros.php">Logros</a></li>
                                <li class="breadcrumb-item active">Alta Logro</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
				<form action="insert-logro.php" method="post" enctype="multipart/form-data"> 
                <div class="row">
                    <div class="col-12">
                        <!-- Card -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alta Logro</h4>
                            ...
                            <div class="card-body">
                                <div class="row" style="margin-top: 34px;">
						            ...
						            <input type="hidden" name="i_principal" value="<?php echo $row_edit['foto'];?>">
										<button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Alta Logro</button>
								</div>
                            </div>
                        </div>	
