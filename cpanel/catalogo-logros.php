...
<head>
    ...
    <title>Temas Logros - <?php echo $title?></title>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Logros</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="alta-logro.php" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i>Alta Logro</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
<?php 
$query_ = "SELECT * FROM logros ORDER BY id DESC";
...
?>                                            <tr>
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                <a class="dropdown-item" href="editar-logro.php?id=<?php echo $row['id'];?>">Editar</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="borrar-logro.php?id=<?php echo $row['id'];?>">Borrar</a>
                                            </div>
                                        </div>
											</td>
                                            </tr>
