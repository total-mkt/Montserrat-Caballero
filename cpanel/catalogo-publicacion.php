...
<head>
    ...
    <title>Publicación - <?php echo $title?></title>
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="alta-publicacion.php" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i>Alta Publicación</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
<?php 
$query_ = "SELECT * FROM monitor_publicacion ORDER BY id DESC";
...
?>                                            <tr>
                                                ...
                                                <td><a href="<?php echo $row['link'];?>" target="_blank">Ver Nota</a></td>
                                                <td>
											<div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                <a class="dropdown-item" href="seguimiento-publicacion.php?id=<?php echo $row['id'];?>">Seguimiento</a>
												<div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="alta-seguimiento-publicacion.php?id=<?php echo $row['id'];?>">Alta Seguimiento</a>
												<div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="editar-publicacion.php?id=<?php echo $row['id'];?>">Editar</a>
                                                <a class="dropdown-item" href="borrar-publicacion.php?id=<?php echo $row['id'];?>">Borrar</a>
                                            </div>
                                        </div>
											</td>
                                            </tr>
