...
$query_edit = sprintf("SELECT * FROM blog WHERE id = %s",
...
<head>
    ...
    <title>Alta Blog - <?php echo $title?></title>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Editar Tema</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="./"><?php echo _INICIO?></a></li>
                                <li class="breadcrumb-item"><a href="./catalogo-blog.php">Temas</a></li>
                                <li class="breadcrumb-item active">Editar Tema</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row" style="margin-top: 34px;">
									...
									<div class="form-group">
                                        ...
                                        <select class="form-control custom-select" name="categoria" id="categoria" required>
										  ...
										  <option value="Blog Sitio">Blog Sitio</option>
										  <option value="Facebook Post">Facebook Post</option>
										  <option value="Facebook Video">Facebook Video</option>
										  <option value="Facebook Galeria">Facebook Galeria</option>
									...
									<div class="form-group">
                                        <label>Video</label>
                                        <input type="input" class="form-control" name="video" value="<?php echo $editando['video'];?>" style="cursor: auto;"> 
									</div>
									</div>
									...
									<div class="form-group">
                                        <label>Extracto</label>
                                         <input type="input" class="form-control" name="excerp" value="<?php echo $editando['excerp'];?>" maxlength="310"> 
									</div>
									</div>
									...
									<div class="col-md-6" style="margin-top: 16px;">
									<div class="form-group">
                                        <img src="../<?php echo $editando['imagen'];?>" alt="">
									</div>
									</div>
                            ...
                            <div class="card-body">
                                <div class="row" style="margin-top: 34px;">
						            ...
						            <input type="hidden" name="i_principal" value="<?php echo $editando['imagen'];?>">
										<button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Editar Tema</button>
								</div>
                            </div>
                        </div>	
