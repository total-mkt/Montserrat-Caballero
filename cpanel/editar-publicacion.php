...
<head>
    ...
    <title>Editar Publicación - <?php echo $title?></title>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="./catalogo-publicacion.php">Publicaciones</a></li>
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
				<form action="update-publicacion.php" method="post" enctype="multipart/form-data"> 
                <div class="row">
                    <div class="col-12">
                        <!-- Card -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row" style="margin-top: 34px;">
									...
									<div class="form-group">
                                        <label>Link</label>
                                        <input type="input" class="form-control" name="link" value="<?php echo $editando['link'];?>" style="cursor: auto;"> 
									</div>
									</div>
                            ...
                            <div class="card-body">
                                <div class="row" style="margin-top: 34px;">
						            ...
						            <input type="hidden" name="i_principal" value="<?php echo $editando['imagen'];?>">
										<button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Editar Publicación</button>
								</div>
                            </div>
                        </div>	
