...
$query_edit = sprintf("SELECT * FROM videos WHERE id = %s",
...
<head>
    ...
    <title>Editar Video - <?php echo $title?></title>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Editar Video</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="./"><?php echo _INICIO?></a></li>
                                <li class="breadcrumb-item"><a href="./catalogo-video.php">Video</a></li>
                                <li class="breadcrumb-item active">Editar Video</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
				<form action="update-video.php" method="post" enctype="multipart/form-data"> 
                <div class="row">
                    <div class="col-12">
                        <!-- Card -->
                            ...
                            <div class="card-body">
                                <div class="row" style="margin-top: 34px;">
						            ...
						            <input type="hidden" name="i_principal" value="<?php echo $editando['imagen'];?>">
										<button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Editar Video</button>
								</div>
                            </div>
                        </div>	
