...
// Insert 
	...
	$insertSQL = sprintf("INSERT INTO blog (fecha, dia, mes, anio, categoria, titulo, permalink, excerp, contenido, imagen, video, mostrar) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 // Vamonos! 
  ...
  $insertGoTo = $url."catalogo-blog.php";
