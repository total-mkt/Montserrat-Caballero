...
// Insert 
	...
	$insertSQL = sprintf("INSERT INTO testimonios (fecha, dia, mes, anio, categoria, titulo, permalink, contenido, foto, testimonio, nombre, apellido, mostrar) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
