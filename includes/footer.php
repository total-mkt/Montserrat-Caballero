                    ...
                    <div class="uk-width-1-1 de-footer__widget">
                      <div id="text-2" class="widget widget_text de-footer-top-inner">
                        ...
                        <div class="textwidget">
                          ...
                          <p><img class="alignnone size-full wp-image-787" src="images/firma-montserrat-gris.png" alt="<?php echo $title;?>" width="246" height="71" /></p>
                        </div>
                      </div>
                    ...
                    <div class="uk-width-1-1 de-footer__widget">
                      <div id="dahz_post_categories_widget-3" class="widget widget_dahz_post_categories_widget de-footer-top-inner">
                        <div class="dahz-widget__wrapper dahz-widget__wrapper--dahz_post_categories_widget">
                          ...
                          <p><img class="alignnone size-full wp-image-787" src="images/logo-congreso-bc-gris.png" alt="Congreso del estado de B.C."/></p>
                        </div>
                         </div>
                      </div>
                      <hr class="de-sidebar__widget-separator uk-margin-medium" />
            ...
            <div id="footer-section-3-row-0" class="de-footer__row uk-grid uk-grid-medium" data-uk-grid="">
              <div id="footer-section-3-row-0-column-0" class="uk-flex uk-flex-wrap uk-flex-row uk-width-1-1 uk-width-1-1@m">
                <div class="uk-grid uk-flex-1 uk-child-width-1-1 uk-flex-center" data-uk-grid="">
                  <div data-section="3" data-builder-type="footer" data-item-id="footer_logo" data-item-is-lazyload="" class="uk-flex uk-flex-middle uk-flex-wrap uk-flex-center"> <a href="./" rel="home"> <img src="images/logo-login.png" data-src-2x="images/logo-montserrat-footer.png" data-src-3x="images/logo-montserrat-footer.png" alt="<?php echo $title;?>" /> </a> </div>
                </div>
              </div>
            </div>
                ...
                <div class="uk-grid uk-flex-1 uk-child-width-1-1 uk-flex-center" data-uk-grid="">
                  <div data-section="3" data-builder-type="footer" data-item-id="footer_menu" data-item-is-lazyload="" class="uk-flex uk-flex-middle uk-flex-wrap uk-flex-center">
                    <ul id="menu-footer" class="de-footer-menu de-footer-menu--style-2">
                      <li class="menu-item menu-item-type-post_type menu-item-object-page"><a href="montserrat-caballero/" style="color: #666;">¿Quién Soy?</a></li>
                      <li class="menu-item menu-item-type-post_type menu-item-object-page"><a href="politica-de-privacidad/" style="color: #666;">Política de Privacidad</a></li>
                      <li class="menu-item menu-item-type-post_type menu-item-object-page"><a href="terminos-y-condiciones/" style="color: #666;">Términos y Condiciones</a></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div class="uk-grid uk-flex-1 uk-child-width-1-1 uk-flex-center" data-uk-grid="">
                  <div data-section="3" data-builder-type="footer" data-item-id="site_copyright" data-item-is-lazyload="" class="uk-flex uk-flex-middle uk-flex-wrap uk-flex-center">
                    <div class="site-info uk-text-center">
                      <p class="uk-margin-remove" style="color: #999;"> &#169;<?php echo date('Y');?> <?php echo $title;?> - Desarrollo por <a href="<?php echo $desarrollo;?>" target="_blank" style="color: #666;">Total Marketing</a> </p>
                    </div>
                  </div>
                </div>
              </div>
