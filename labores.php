...
<title>Mi Labor &#8211; <?php echo $title;?></title>
			...
			@media only screen and ( min-width: 1024px ) and ( max-width: 1024px ) {
				h3[data-dahz-shortcode-key="1536117462427-06277516-837a"] {
					...
					line-height: inherit;
                                    ...
                                    <h3 style="font-size: 48px; line-height: 1.2; text-align: left;" class="uk-margin de-sc-heading" data-dahz-shortcode-key="1536117462427-06277516-837a"> Mis Labores<br />
                                      como Diputada </h3>
                                    <div style="" class="uk-margin">
                                      <div class="de-textblock-wrapper">
...
$mostrar = 'Si';
$categoria = 'Labores';
$query_L = sprintf("SELECT * FROM logros WHERE mostrar = %s AND categoria = %s ORDER BY orden ASC",
...
<a href="mis-labores/<?php echo $labor['permalink'];?>" title="<?php echo $labor['titulo'];?>" target="_self">
<img width="720" height="781" class="attachment-single-post-thumbnail size-single-post-thumbnail ds-lazy-image" alt="<?php echo $labor['titulo'];?>" sizes="(max-width: 720px) 100vw, 720px" data-uk-img="" data-src="<?php echo $labor['imagen'];?>" data-srcset="<?php echo $labor['imagen'];?> 720w, <?php echo $labor['imagen'];?> 277w, <?php echo $labor['imagen'];?> 600w" />
                                      ...
                                      <div class="de-sc-team-member__content uk-text-left">
                                        <div class="de-sc-team-member__content__description uk-margin uk-margin-remove-bottom">
                                          <h6 class="uk-margin-small-bottom uk-padding-remove de-sc-team-member__image__content--name" > <a href="mis-labores/<?php echo $labor['permalink'];?>" title="<?php echo $labor['titulo'];?>" target="_self" rel=""> <?php echo $labor['titulo'];?> </a> </h6>
