			...
			@media only screen and ( min-width: 1024px ) and ( max-width: 1024px ) {
				h3[data-dahz-shortcode-key="1536117462427-06277516-837a"] {
					...
					line-height: inherit;
                                    ...
                                    <h3 style="font-size: 48px; line-height: 1.2; text-align: left;" class="uk-margin de-sc-heading" data-dahz-shortcode-key="1536117462427-06277516-837a"> Noticias</h3>
                                    <div style="" class="uk-margin">
                                      <div class="de-textblock-wrapper">
      ...
      <div class="uk-width-expand@m de-main-content uk-first-column" style="position: relative; overflow: visible; box-sizing: border-box; min-height: 1px;">
        <div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none;">
          <div class="de-content uk-child-width-1-1@s uk-child-width-1-2@m uk-grid-large uk-grid" data-uk-grid="">
                <?php
                $consulta_noticias = "SELECT * FROM blog WHERE mostrar = 'Si'";
                ...
                if ( $num_total_registros > 0 ) {
                  ...
                  $consulta = "SELECT * FROM blog WHERE mostrar = 'Si' ORDER BY fecha DESC LIMIT " . $inicio . "," . $TAMANO_PAGINA;
