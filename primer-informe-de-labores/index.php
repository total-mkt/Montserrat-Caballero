...
<html lang="es" itemscope itemtype="http://schema.org/WebPage">
  <head>
    ...
    <!-- title -->
    <title>Primer Informe de Labores - Diputada Montserrat Caballero</title>        
...
<div id="fb5-ajax" data-cat="your_book_name"> 			
    ...
    <div class="fb5" id="fb5">      
        ...
        <section id="config">
         <ul>
            <li key="page_width">1373</li>              <!-- width for page -->
            <li key="page_height">1012</li>             <!-- height for page -->
...
<?php for($i=1; $i<=52; $i++){?>                                     
                        ...
                        <div data-background-image="libro/<?php echo $i;?>-min.jpg">          
...
<?php for($i=1; $i<=52; $i++){?>                   
                                             <!-- thumb <?php echo $i;?> -->
                                             <li class="<?php echo $i;?>">
                                                  <img alt="" data-src="imgresize.php?w=340&img=libro/<?php echo $i;?>-min.jpg">
