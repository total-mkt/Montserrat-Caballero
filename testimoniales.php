...
<title>Testimonios de Salud &#8211; <?php echo $title;?></title>
...
<div class="uk-offcanvas-content">
  <div class="de-page-container ds-single-page de-content-fullwidth" id="page">
    <div class="page-wrapper">
      ...
      <div class="de-page-title uk-section" data-layout="trina" data-render-location="page" style="background-color:#5d1030; background-image:url(images/cabeceras/testimonios-salud.jpg);background-position:left top;background-repeat:no-repeat;background-size:cover;background-attachment:scroll;">
        <div class="de-page-title__container uk-container">
          <h1 class=" uk-heading-primary" style="font-size: 49px; font-weight: 400">Testimoniales de Salud</h1>
          <ul class="uk-breadcrumb uk-text-small">
            <li> <a class="uk-link" href="./" title="<?php $title;?>"> Inicio </a> </li>
            <li> <span class="bread-current"> Testimoniales de Salud </span> </li>
          </ul>
        </div>
      </div>
	
	<?php } if($_REQUEST['pagina'] == ''){?>	
	<div data-dahz-id="1536115680907-c9928351-05b8" class="de-section uk-section uk-section-large uk-background-cover uk-background-norepeat uk-background-top-left parallax" style="background-image: url(images/cabeceras/testimonios-salud.jpg); background-color: #eaeaea !important;" data-uk-parallax="bgx:0,0;bgy:-100,110;media: (min-width: 1200px);">
			...
			@media only screen and ( min-width: 1024px ) and ( max-width: 1024px ) {
				h3[data-dahz-shortcode-key="1536117462427-06277516-837a"] {
					...
					line-height: inherit;
                                    ...
                                    <h3 style="font-size: 48px; line-height: 1.2; text-align: left;" class="uk-margin de-sc-heading" data-dahz-shortcode-key="1536117462427-06277516-837a"> Testimoniales de <br>
										Salud</h3>
                                    <div style="" class="uk-margin">
                                      <div class="de-textblock-wrapper">
          ...
          <div class="uk-grid-large de-main-grid uk-grid uk-grid-stack" data-uk-grid="" style="transform: none;">
            <div class="uk-width-expand@m de-main-content uk-first-column" style="transform: none;">
              <div class="de-content uk-child-width-1-1@s uk-grid uk-grid-stack" data-uk-grid="" style="transform: none;">
                <?php
                $consulta_noticias = "SELECT * FROM testimonios WHERE categoria = 'Salud' AND mostrar = 'Si'";
                ...
                if ( $num_total_registros > 0 ) {
                  ...
                  $consulta = "SELECT * FROM testimonios WHERE categoria = 'Salud' AND mostrar = 'Si' ORDER BY fecha DESC LIMIT " . $inicio . "," . $TAMANO_PAGINA;
                        ...
                        <div data-uk-grid="" data-uk-height-match="target: > div;row:false;" class="uk-grid uk-grid-stack">
                          <div class="uk-width-expand@m uk-first-column">
                            <div class="tribe-events-event-image">
                              <iframe width="1280" height="720" src="https://www.youtube.com/embed/<?php echo $row['permalink'];?>" allowfullscreen></iframe>
                            </div>
                          </div>
                        </div>
